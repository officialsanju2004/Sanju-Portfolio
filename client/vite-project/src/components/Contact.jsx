...
let [enquiryList, setEnquiryList] = useState([]);
 ...
 setIsSubmitting(true);
    ...
    axios
      .post("https://sanju-portfolio-vert.vercel.app/web/api/enquiry/enquiry-insert", formData)
      .then((res) => {
  ...
  let getAllEnquiries = () => {
    axios
      .get("https://sanju-portfolio-vert.vercel.app/web/api/enquiry/enquiry-view")
      .then((res) => {
